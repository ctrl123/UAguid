...
public class Crous extends AppCompatActivity {
    ...
    // URL to get JSON
    private static String urlperso = "http://" + ip + "/UAGuid/JSON.php?sujet=crous";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crous);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                closeBtn.setBackgroundColor(Color.parseColor("#E54F36"));
                ...
                popUp.showAtLocation(findViewById(R.id.crous_layout), Gravity.CENTER, 0, 0);
            }
        });
    }
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Crous.this);
