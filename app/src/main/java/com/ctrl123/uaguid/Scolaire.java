...
public class Scolaire extends AppCompatActivity {
    ...
    // URL to get JSON
    private static String urlperso = "http://" + ip + "/UAGuid/JSON.php?sujet=admin";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scolaire);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                closeBtn.setBackgroundColor(Color.parseColor("#079FCE"));
                ...
                popUp.showAtLocation(findViewById(R.id.scolaire_layout), Gravity.CENTER, 0, 0);
            }
        });
    }
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Scolaire.this);
